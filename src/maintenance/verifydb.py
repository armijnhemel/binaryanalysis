...
'''
This script verifies that the tables in a database are in sync, which means:
all of the files in the tables "extracted_string" and "extracted_function" can
also be found in "processed_file"
'''
