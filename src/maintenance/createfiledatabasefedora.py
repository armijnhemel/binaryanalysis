...
'''
This script mines data from Fedora package databases (available on any Fedora
mirror under os/repodata) and puts it in another database.

The names of the files that are needed end in "filelists.sqlite.bz2"
(file list database) and "primary.sqlite.bz2" (package database)
