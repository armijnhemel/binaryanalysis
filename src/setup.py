...
setup(name='bat',
      ...
      packages=['bat'],
      license="Apache 2.0",
      scripts=['maintenance/batconfigcheck.py', 'maintenance/busybox-appletname-extractor.py', 'maintenance/clonedbinit.py', 'bruteforce.py', 'busybox-compare-configs.py', 'batgui', 'bat-findlibs'],
