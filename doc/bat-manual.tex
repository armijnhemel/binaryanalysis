...
\subsection{Setting the databases}
...
The names of the caching databases start with \texttt{BAT\_SQLITE\_AVG} and
\texttt{BAT\_SQLITE\_STRINGSCACHE} and are postfixed with an underscore and
the name of the programming language family, for example \texttt{\_JAVA}.
