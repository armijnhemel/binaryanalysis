...
\title{Binary Analysis Tool User and Developer Manual - describing version 18}
...
In BAT 18 the following file systems, compressed files and media files can be
...
Currently (BAT 18) if \texttt{cleanup} is set the files are written directly to
...
The order of the unpack scans as defined in BAT 18 is:
