...
a scan will still make it possible to enable it later in the graphical user
interface.

To prevent a scan from being enabled in the graphical user interface outcomment
the entry in the configuration file (by starting the line with the \texttt{\#}
character), or remove the section from the configuration file.
