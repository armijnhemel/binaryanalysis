...
Historically BAT used SQLite as its database engine. Support for PostgreSQL was
added as an alternative later. Since BAT 26 only PostgreSQL is supported.

For PostgreSQL a few variables have to be set to be able to connect with the
database server, namely the username, password and database name:
...
specified. For example on CentOS 6.x both parameters have to be set.
