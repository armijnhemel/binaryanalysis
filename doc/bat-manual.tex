...
added as an alternative later. Since BAT 26 only PostgreSQL is supported in the
scanner, while the database creation script still uses SQLite. This will be
changed in BAT 27.
