...
envvars     = BAT_AVG_C=/home/armijn/master/avg:
              ...
              BAT_FUNCTIONNAME_CACHE=/home/armijn/master/funccache:
...
\texttt{BAT\_STRINGSCACHE} and \texttt{BAT\_AVG} and are
...
\texttt{BAT\_DB}. If there is no value supplied via the environment it will use
a hardcoded value (although this is likely to be removed in a future version):
