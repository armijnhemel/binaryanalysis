...
the scans is specified. In this section the rationale behind this ordering is
explained.

The order for pre-run scans, unpack scans, leaf scans and aggregate scans are
determined. Since postrun scans do not change the result files and they are 
