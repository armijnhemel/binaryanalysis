...
\title{Binary Analysis Tool User and Developer Manual - describing version 24}
...
In BAT 24 the following file systems, compressed files and media files can be
...
by individual scans. For example to set the environment variable
\texttt{BAT\_NAMECACHE\_C} for all scans you would put something like this in
...
Currently (BAT 24) if \texttt{cleanup} is set the files are written directly to
...
The order of the unpack scans as defined in BAT 24 is:
