...
\texttt{batgui}, \texttt{busybox.py} and \texttt{busybox-compare-configs.py}.
...
determine what is inside by applying a wide range of methods, such as looking
for known identifiers of file systems and compressed files and running external
...
known markers of compressed files and file systems. Which markers are searched
for depends on the contents of the configuration file (specifically the
\texttt{magic} attribute). These markers determine other methods, such as
unpackers, are run.
