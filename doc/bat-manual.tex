...
\title{Binary Analysis Tool User and Developer Manual - describing version 14}
...
In the standard distribution of BAT file \texttt{bat/ranking.py} contains a very
extensive example.
