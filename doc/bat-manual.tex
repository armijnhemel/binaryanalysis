...
\title{Binary Analysis Tool User and Developer Manual - describing version 12}
...
\texttt{BAT\_STRINGSCACHE}, \texttt{BAT\_FUNCTIONNAMECACHE} and
\texttt{BAT\_AVG} and are postfixed with an underscore and the name of the
programming language family.  The strings cache database for Java for example
is configured using the environment variable \texttt{BAT\_STRINGSCACHE\_JAVA}.
