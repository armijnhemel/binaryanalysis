...
Binary Analysis Tool (BAT) is a generic framework for automated analysis of binary files:
...
If you can relate many strings from a binary file to source code it becomes statistically hard to deny use of GPL software.
}
...
or use a web browser such as Firefox.
}
