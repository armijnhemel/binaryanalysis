...
\usepackage{tikz}
\author{Armijn Hemel}
\title{Using the Binary Analysis Tool}
...
\frame{
\frametitle{Automating extraction using BAT}
...
BAT can be configured through a configuration file. This file is in Windows INI format:
