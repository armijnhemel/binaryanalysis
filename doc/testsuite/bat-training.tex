...
First make sure BAT (version 8 or higher), plus all necessary dependencies are installed. Then run:
...
A word of warning: result files can become rather large and unpacking files can be slow.
}
