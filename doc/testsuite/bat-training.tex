...
\item full corresponding source code available and GPL compliant
\end{itemize}
}

\frame{
\frametitle{Manual compliance engineering}
To understand how BAT works you need to know what it does. We will look at:

\begin{itemize}
\item manual discovery of offsets
\item manually unpacking of file systems
\item manual analysis of binaries
\end{itemize}
}
...
\texttt{dd if=/path/to/firmware of=/path/to/outfile bs=1 skip=\$offset}
}
...
Make sure BAT and the \texttt{bat-extratools} package are installed (version 6 or higher)
