...
%Because function names need to be resolved during runtime (``dynamic linking'') they need to be declared ...
}
...
Above techniques are quite easy to beat. String comparisons can be beaten by changing strings. Function name comparisons can be beaten by changing function names.
